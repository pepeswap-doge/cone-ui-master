...
const socialLinks = {
  twitter: "https://twitter.com/pepeswapp",
  discord: "https://discord.gg/EsMFgSTpEB",
  telegram: "https://t.me/+rnvU4HFpE7dlZDdk",
  gitbook: "https://whitepaper.pepeswap.xyz/",
  medium: "https://medium.com/@P3P3Swap",
};
...
const HomePage = () => {
      ...
      <div className={classes.row}>
        <div className={classes.column}>
          ...
          <p className={classes.subtitle}>
            PepeSwap offers users quick, seamless and cheap transactions while
        ...
        <div className={classes.column}>
          <p className={classes.title2} style={{color: "#000000"}}>0.01% Swapping</p>
          <p className={classes.title2} style={{color: "#000000"}}>Fee Tokenized</p>
          <p className={classes.title2} style={{color: "#000000"}}>locks</p>
      ...
      <div className={classes.row}>
        <div className={classes.column}>
          <div className={classes.text}>
            <p>PepeSwap is a decentralized exchange on the DogeChain network with low fees, near 0 slippage on correlated assets and a strong focus on secondary markets for tokenized locks as NFT's (veToken = lpNFTs).</p>
          </div>
        </div>
        <div className={classes.column}>
          <div className={classes.text}>
            ...
            <p>PepeSwap offers users quick, seamless and cheap transactions while utilizing strategies to maximize their yield.</p>
          </div>
        </div>
      </div>
      <a href="https://docs.pepeswap.xyz" className={classes.infoButton}>
  ...
  //                     <p>Pepe officially launched in April 2022 with a collective goal of <b>fair and balanced access to DeFi</b>.</p>
  //                     <p>Pepe is a decentralized exchange that has launched on the Polygon network with low fees, near 0 slippage on correlated assets and a strong focus on secondary markets for tokenized locks as NFT’s (veToken = lpNFTs).</p>
  //                 </div>
  //                 <div className={classes.layoutDescriptionSmallText}>
  //                     <p>One segment of the cryptocurrency landscape that has shown incredible potential is the swapping of stablecoins and volatile assets. PepeSwap offers users quick, seamless and cheap transactions while utilizing strategies to maximize their yield.</p>
  //                 </div>
  //             </div>
  //         </div>
  //     </div>

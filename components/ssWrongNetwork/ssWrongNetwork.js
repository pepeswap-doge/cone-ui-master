      ...
      <div className={classes.dialogContainer}>
        <div className={classes.warningContainer}>
          ...
          <Typography className={classes.paragraph}>
            Please check that your wallet is connected to DogeChain, only
            after you can proceed. If you do not have a DogeChain in your
            wallet, you can add it through the footer link.
          </Typography>

          <div className={classes.buttonsContainer}>
            <a className={classes.primaryButton} href="https://chainlist.org/chain/2000" target="_blank" rel="noreferrer">

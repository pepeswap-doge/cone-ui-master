    ...
    return (
        <svg style={{pointerEvents: 'none', position: 'absolute', right: 16,}} width="18" height="9"
          ...
          <path
              ...
              stroke="#029926" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                      ...
                      <DialogContent style={{
                        ...
                        <div className={classes.tokenSelect}>
                          <Select
                              ...
                              style={{
                                border: '1px solid #029926', // always visible
                              }}
                              fullWidth
                              MenuProps={{
                                classes: {

...
export default function ffWarning({close, title, subTitle, icon, description, btnLabel1, btnLabel2, action2}) {
  const navigateToMedium = () => {
    ...
    window.open("https://docs.pepeswap.xyz", "_blank");
  };
            ...
            {description
              ...
              : <>
                <p className={classes.paragraph1}>
                  Use of the Pepe.exchange website, services, dapp, or application is subject to the following Terms & Conditions and hereby confirm that by proceeding and interacting with the protocoL I am aware of these and accept them in full:
                </p>
                <p>Pepe.exchange is a smart contract protocol in alpha stage of launch, and even though multiple
                security audits have been completed on the smart contracts, I understand the risks associated with using the
                Pepe protocol and associated functions.</p>
                <p>Any interactions that I have with the associated Pepe protocol apps, smart contracts or any related
                functions MAY place my funds at risk, and hereby release the Pepe protocol and its contributors,

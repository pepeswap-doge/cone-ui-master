...
export default function ssLiquidityManage({initActiveTab = 'deposit',}) {
  ...
  const callQuoteAddLiquidity = (
    ...
    if (parseFloat(pp?.reserve0) != 0 && parseFloat(pp?.reserve1) != 0) {
      ...
      if (assetA.address === "WDOGE") {
        addy0 = CONTRACTS.WFTM_ADDRESS;
      }
      if (assetB.address === "WDOGE") {
      ...
      <ClickAwayListener onClickAway={closeSelect}>
        ...
        >
          <svg width="18" height="9" viewBox="0 0 18 9" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M16.9201 0.950012L10.4001 7.47001C9.63008 8.24001 8.37008 8.24001 7.60008 7.47001L1.08008 0.950012" stroke="#029926" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        </div>
      </ClickAwayListener>
    );
